...
contract Exchange is ERC20 {
  ...
  */
  function addLiquidity(uint _amount) public payable returns (uint) {
    ...
    ERC20 cryptoDevToken = ERC20(cryptDevTokenAddress);
    ...
    if(cryptoDevTokenReserve == 0) {
      ...
      /*
        ...
        */
        ...
        require(_amount >= cryptoDevTokenAmount, "Amount of tokens sent is less than the minimum amount of tokens required.");
  ...
  */
  function removeLiquidity(uint _amount) public returns (uint, uint) {
    ...
    ERC20(cryptDevTokenAddress).transfer(msg.sender, cryptoDevTokenAmount);
  ...
  */
  function ethToCryptoDevToken(uint _minTokens) public payable {
    ...
    ERC20(cryptDevTokenAddress).transfer(msg.sender, tokensBought);
  }
  ...
  */
  function cryptoDevTokenToEth(uint _tokensSold, uint _mintEth) public {
    ...
    ERC20(cryptDevTokenAddress).transferFrom(
      msg.sender,
      address(this),
      _tokensSold
    );
